...
// // int x = (frameSize.width - panel.getWidth()) / 2; // Panel width is half
// of
// // the frame's width
...
// // JLabel textDataPrivacyDetails = new JLabel("<html>In accordance to the
// Data
...
// JLabel textDataPrivacy = new JLabel("Data Privacy");
// textDataPrivacy.setFont(new Font(null, Font.BOLD, 35));
// textDataPrivacy.setAlignmentX(Component.CENTER_ALIGNMENT); // Center the
// label
// textDataPrivacy.setPreferredSize(new Dimension(50, 50));

// // Details for data privacy
// String detailsDataPrivacy = "&nbsp;&nbsp;&nbsp;&nbsp;In accordance to the
// Data Privacy Act of 2012, the personal information shared will only be used
// to create and for personal use of your account."
// + "<p>&nbsp;&nbsp;&nbsp;&nbsp;All information collected during sign-up will
// not be shared with any third parties."
// + "<p>&nbsp;&nbsp;&nbsp;&nbsp;We will use your data solely for the purpose of
// providing services related to your account and will not disclose it to
// external parties without your consent."
// + "<p>&nbsp;&nbsp;&nbsp;&nbsp;Your data will be stored securely using
// industry-standard encryption methods to ensure confidentiality."
// + "<p>&nbsp;&nbsp;&nbsp;&nbsp;You will always have the right to access,
// modify, or delete your personal information upon request."
// + "<p>&nbsp;&nbsp;&nbsp;&nbsp;Any information provided voluntarily for
// promotional purposes will be handled according to your preferences and
// consent."
// + "<p>&nbsp;&nbsp;&nbsp;&nbsp;We will retain your information only for as
// long as necessary to fulfill the services, and all data will be securely
// deleted when it is no longer required."
// + "<p>&nbsp;&nbsp;&nbsp;&nbsp;We will notify you in advance if there are any
// changes to this privacy policy or if any third-party service providers need
// access to your information for legal reasons.";
// ;
...
// "<html><div style='text-align: justify;'>" + detailsDataPrivacy +
// "</div></html>");
// textDataPrivacyDetails.setAlignmentX(JComponent.CENTER_ALIGNMENT); // Center
// the label
// textDataPrivacyDetails.setEditable(false);
// textDataPrivacyDetails.setBorder(BorderFactory.createEmptyBorder(20, 20, 20,
// 20));
...
// phoneNumberPanel.setLayout(new BoxLayout(phoneNumberPanel,
// BoxLayout.Y_AXIS));
