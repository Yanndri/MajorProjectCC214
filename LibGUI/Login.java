...
public class Login {
    ...
    public static void main(String[] args) {
        ...
        login.storeAccount(new User("Asheerah", "Stop", "Bautro", LocalDate.parse("2005-09-23"), "Kangkong, Cordova",
                "Bayot", "09123456789",
                "asheerahbokiboki", "jedgo123", login.encrypt("asheerahbokiboki")));
        login.storeAccount(new User("Test", "TEST1", "Test2", LocalDate.parse("1992-06-12"), "TestADD",
                "attack Helicopter", "09123213",
