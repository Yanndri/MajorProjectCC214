public class UserAccounts {
    ...
    // return true;
    // if (accounts[slot].nextAccount != null &&
    // accounts[slot].nextAccount.gmail.equals(gmail))
    // return true;
    // else {
    // Account tempNode = accounts[slot];
    // while (!tempNode.nextAccount.gmail.equals(gmail)) { // iterate until false
    // if (tempNode.nextAccount == null) // if reached null that means the gmail
    ...
    // } else if (accounts[slot].nextAccount == null) { // if accounts has no
    // connected node
